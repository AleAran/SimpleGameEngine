...
VertexBuffer2D::VertexBuffer2D(IDirect3DDevice9* pkDevice, size_t uiVertexSize, unsigned int uiFVF)
	:
	m_uiBase(0),
	m_uiVertexToLock(0),
...
//---------------------------------------------------------------------------
void VertexBuffer2D::draw(const void* pvVertices, D3DPRIMITIVETYPE ePrimitiveType, unsigned int uiVertexCount)
{
